...
import { getBrandStory, getYoshidaSettings, getSiteSettings, getReservationUrls, getAllStoreInfo } from "@/lib/notion";

export const revalidate = 60;

export default async function HomePage() {
  const [brand, tea, settings, stores, reservation] = await Promise.all([
