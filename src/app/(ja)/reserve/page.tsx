...
export default async function Page(){const [settings,stores]=await Promise.all([getBookingSettings(),getAllStoreInfo().catch(()=>({ja:{'高台寺店':storeContent.kyoto.info,'熊本店':storeContent.kumamoto.info}}))]);return <><ReservationPage settings={settings} stores={[stores.ja['高台寺店'],stores.ja['熊本店']]}/><Footer/></>;}
